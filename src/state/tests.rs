...
mod tests {
    ...
    fn test_default_log_retention() {
        ...
        let state = super::super::AppState::new(vec![]);
        assert_eq!(state.log_retention, 5);

        unsafe {
            std::env::set_var("STATESYNC_LOG_RETENTION", "0");
        }
        let state_min = super::super::AppState::new(vec![]);
    ...
    fn test_app_state_log_event_retention() {
        let mut state = super::super::AppState::new(vec![]);
    ...
    fn test_app_state_log_sync() {
        ...
        let entry1 = super::super::SyncLogEntry {
        ...
        let entry2 = super::super::SyncLogEntry {
        ...
        let entry3 = super::super::SyncLogEntry {
    ...
    async fn test_init_server_cache_empty() {
        ...
        let cache = super::super::init_server_cache("test_cache", &client).await.unwrap();
